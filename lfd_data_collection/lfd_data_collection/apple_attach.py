...
# This file is used for the playback portion of the package. It looks at the
# position of the fingers. If they are extended and not moving, then the apple
# has been grasped, and it publishes that information.
